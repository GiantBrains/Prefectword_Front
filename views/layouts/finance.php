            ...
            <div class="col-md-2" style="margin-bottom: 20px">
                <div style="border: solid; border-radius: 10px; border-top: none; border-width: thin; height: 275px; border-color: darkgrey">
                    <div style="border: solid; border-left: none; border-right: none; border-top-left-radius: 10px; background-color: #3D715B; border-top-right-radius: 10px; border-width: thin; height: 40px; border-color: darkgrey">
                        <h4 style="color:white; line-height: 20px; vertical-align: middle; margin-left: 20px">
                            Balance</h4>
                    </div>
                    ...
                    <div class="wrapper row">
                        <a style="display: block; margin-top: 15px"
                           href="<?= Yii::$app->request->baseUrl ?>/wallet/index">
                            <button style="width: 120px" class="btn btn-md btn-info <?= $this->params['deposit'] ?>">
                                <span class="glyphicon glyphicon-import" style="font-size: 20px"
                                      aria-hidden="true"></span> &nbsp; Deposit
                            </button>
                        </a>
                    </div>
                </div>
    ...
    <div class="container">
        <diV class="row" style="margin-top: -5px">
            ...
            <ul class="hidden-lg hidden-md hidden-sm col-xs-12" style="list-style-type: none; text-align: center">
                <li><p class="essay-font" style="font-size: 13px; color: #666666;"><?= Yii::$app->name ?>
                        &copy; <?= date('Y') ?> All Rights Reserved &nbsp; </p></li>
                <li><a href="<?= \yii\helpers\Url::to(['site/terms_and_conditions']) ?>"> &nbsp; Terms and
                        Conditions</a></li>
            </ul>
            ...
            <div class="col-md-5 hidden-xs">
                <ul class="pull-right pay-cards">
                    <li><img style="margin-left: 26px"
                             src="<?= Yii::$app->request->baseUrl ?>/images/rating/visapro.jpg" alt="Visa"
                             class="pm visa"></li>
                    <li><img style="margin-left: 26px"
                             src="<?= Yii::$app->request->baseUrl ?>/images/rating/amexpro.jpg" alt="American Express"
                             class="pm ae"></li>
                    <li><img style="margin-left: 26px" src="<?= Yii::$app->request->baseUrl ?>/images/rating/mcard.jpg"
                             alt="MasterCard" class="pm mc"></li>
                    <li><img style="margin-left: 26px"
                             src="<?= Yii::$app->request->baseUrl ?>/images/rating/paypalpro.jpg" alt="PayPal"
                             class="pm paypal"></li>
                </ul>
            </div>
            <ul class="hidden-lg hidden-md hidden-sm col-xs-12"
                style="list-style-type: none; text-align: center; background-color: white">
                <li class="col-xs-4"><img style="margin-left: 26px"
                                          src="<?= Yii::$app->request->baseUrl ?>/images/rating/visapro.jpg" alt="Visa"
                                          class="pm visa"></li>
                <li class="col-xs-4"><img style="margin-left: 26px"
                                          src="<?= Yii::$app->request->baseUrl ?>/images/rating/amexpro.jpg"
                                          alt="American Express" class="pm ae"></li>
                <li class="col-xs-4"><img style="margin-left: 26px"
                                          src="<?= Yii::$app->request->baseUrl ?>/images/rating/mcard.jpg"
                                          alt="MasterCard" class="pm mc"></li>
                <li class="col-xs-12" style="margin-top: 3px;"><img style="margin-left: 26px"
                                                                    src="<?= Yii::$app->request->baseUrl ?>/images/rating/paypalpro.jpg"
                                                                    alt="PayPal" class="pm paypal"></li>
            </ul>
            <div class="col-md-1">
