    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <?= $form->field($model, 'pages_id')->widget(\kartik\depdrop\DepDrop::classname(), [
                ...
                'options'=>[$session['pages_id']? $session['pages_id'] : 1 => ['Selected'=>'selected'],'prompt'=>'---Select pages----'],
                'pluginOptions'=>[
                    'depends'=>['spacing-id'],
            ...
            <?= $form->field($model, 'language_id')->label('Language')->dropDownList(\app\models\Language::getLanguages(), [
                 'prompt'=> '...select Language....', 'id'=>'language-id']) ?>
        </div>
        <div class="col-md-8">
