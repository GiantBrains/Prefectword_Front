...
$calculate = <<<JS
  $(document).ready(function(){
         moment().format('MMMM Do YYYY, h:mm:ss a');
            ...
            $('#min-amount').val('$'+(service*type*urgency*pages*level*spacing*coupon).toFixed(2));
        });
             //write promo code
          ...
          //25 % discount
          var promocode2 = function() {
              var couponcode2 = '$code2';
           return couponcode2;    
          };
          //50 % discount
          var promocode3 = function() {
              var couponcode3 = '$code3';
           return couponcode3;    
          };
              var wrongpromo = function() {
           return 'Pay full';    
          };
              
          
              //end of write promocode
        ...
        //coupon code
          $('#coupon-btn').click("focusin",function(e) {
            var nameValue = document.getElementById("coupon-code").value;
            var couponcode = '$couponcode';
            var couponcode2 = '$code2';
            var couponcode3 = '$code3';
            
            if(nameValue === couponcode){
                coupon = $couponamt;
                document.getElementById("coupon-status").innerHTML="Success!"
                document.getElementById("order-promocode").value = promocode();
            }else if(nameValue === couponcode2){
                coupon = $code2amt;
                document.getElementById("coupon-status").innerHTML="Success!"
                document.getElementById("order-promocode").value = promocode2();
                
            }else if(nameValue === couponcode3){
                coupon = $code3amt;
                document.getElementById("coupon-status").innerHTML="Success!"
                document.getElementById("order-promocode").value = promocode3();
            } else{
                 coupon = 1;
                 document.getElementById("coupon-status").innerHTML="Incorrect Code!!"
                 document.getElementById("order-promocode").value = wrongpromo();
            }
            $('#min-amount').val('$'+(service*type*urgency*pages*level*spacing*coupon).toFixed(2));
        });
         //end of coupon code
