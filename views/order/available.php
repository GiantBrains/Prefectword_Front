...
$this->title = 'Waiting to be Assigned';
...
<div class="myorder" style="margin-left: -10px">
    ...
    <div class="row">
            ...
            <?php  echo '<div class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li><a href="'.Yii::$app->request->baseUrl.'/order/pending"><i class="fa fa-list " aria-hidden="true"></i> Pending ('.$this->params['pending_count'].')</a></li>
                                 <li class="active"><a href="'.Yii::$app->request->baseUrl.'/order/available"><i class="fa fa-clock-o" aria-hidden="true"></i> Waiting to be assigned ('.$this->params['available_count'].')</a></li>
        ...
        <div class="col-md-4  col-md-push-8 col-sm-4  col-sm-push-8 col-xs-8">
            <?php  echo $this->render('_available', ['model' => $searchModel]); ?>
        </div>
    </div>
