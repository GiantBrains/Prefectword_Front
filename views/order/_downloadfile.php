...
<tr class="cart_item">
    ...
    <td  style="padding-top: 5px; padding-bottom: 5px">
        <span><a type="button" class="btn btn-xs btn-info" href="<?= \yii\helpers\Url::to(['order/download', 'file_name'=>$model->name, 'file_date'=>$model->file_date, 'file_extension'=>$model->file_extension])?>"> <i class="fa fa-download fa-2x" aria-hidden="true"></i></a></span>
    </td>
</tr>