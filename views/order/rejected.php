        ...
        <div class="hidden-lg hidden-md hidden-sm col-xs-4">
            <?php  echo '<div class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="'.Yii::$app->request->baseUrl.'/order/rejected"><i class="fa fa-thumbs-down " aria-hidden="true"></i> Rejected ('.$this->params['rejected_count'].')</a></li>
                              </ul>
                            </div>';
            ?>
        </div>
        <div class="col-md-4  col-md-push-8 col-sm-4  col-sm-push-8 col-xs-8">
            <?php  echo $this->render('_rejected', ['model' => $searchModel]); ?>
        </div>
    </div>
