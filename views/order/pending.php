...
$this->title = 'Orders Pending Payment';
...
<div class="myorder" style="margin-left: -10px">
    ...
    <div class="row">
        <div class="hidden-lg hidden-md hidden-sm col-xs-4">
            <?php  echo '<div class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="'.Yii::$app->request->baseUrl.'/order/pending"><i class="fa fa-list " aria-hidden="true"></i> Pending ('.$this->params['pending_count'].')</a></li>
        ...
        <div class="col-md-4  col-md-push-8 col-sm-4  col-sm-push-8 col-xs-8">
            <?php  echo $this->render('_pending', ['model' => $searchModel]); ?>
        </div>
    </div>
...
//                'edited_by',
            ...
            [
                ...
                'format' => 'raw',
                'value'=> function ($model, $key, $index, $column) {
                    return   Html::a('Reserve', ['/order/reserve','oid'=>$model->ordernumber], ['class' => 'btn btn-success']);
                }
            ],
            //'sources_id',
            //'language_id',
