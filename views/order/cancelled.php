...
<div class="myorder" style="margin-left: -10px">
    ...
    <div class="row">
        <div class="hidden-lg hidden-md hidden-sm col-xs-4">
            <?php  echo '<div class="dropdown">
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li class="active"><a href="'.Yii::$app->request->baseUrl.'/order/cancelled"><i class="fa fa-close" aria-hidden="true"></i> Cancelled ('.$this->params['cancel_count'].')</a></li>
        ...
        <div class="col-md-4  col-md-push-8 col-sm-4  col-sm-push-8 col-xs-8">
            <?php  echo $this->render('_cancelled', ['model' => $searchModel]); ?>
        </div>
    </div>
