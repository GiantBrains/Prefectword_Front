...
$this->registerMetaTag([
    'name' => 'description',
    'content' => 'Protected customer information. We never disclose students’ identities to anyone. Our students remain anonymous.'
]);
...
<div class="container" style="background-color: #fff">
    ...
    <div class="site-privacy">
        ...
        <<p>At Verified professors.com, we value the privacy and the confidentiality of every customer visiting our site very much.
                As such, we recommend that every user reads through these policies from time to time before using our services.</p>

            <p>As stated above, doctorateessays.com values the privacy of all customers. As such, we like making their personal identity 100% anonymous.
                We do not share any personal details disclosed to us by our customers or writers to any other third party.
            ...
            <p>At all time, doctorateessays.com will act as the link between the customer and the writer, and as such,
            ...
            <p>We are professional people, and therefore we expect our writers to observe professionalism at all times.
                Professionalism involves how you chat with our customers. Observe etiquette at all times in your chats with your customers.
                Do not share any personal information such as emails and contacts with our customers as this violates our privacy policy.
                We always monitor the writer-client chats and therefore and therefore will heavily fine or fire any writer that tries to
                share their emails and contacts with their customers. No form of explanation will be accepted for such an act whether
                deliberately or by mistake. We, therefore, recommend that you be very keen on what you send to your customer in your chats.</p>
            <p>We might collect other information such as your IP address and your access time.
                ...
                These cookies also help us to understand the pages of our website that you visited and how much time you spent on each of the
                pages you visited.</p>
            <p>As you understand, time is of critical importance to us as we seek to
                ...
                However, it is important to note that the above-collected information is only used by us and not shared by any other third
                party whatsoever.  Basically, we ensure user security at all times by putting in place measures for that purpose.</p>
            <p>We are a developing company, and as such, our privacy policy is subject to changes whenever need be.
                We, therefore, would like to advise all our users always to keep checking for any possible update on this page.</p>
        </div>
    </div>
</div>
