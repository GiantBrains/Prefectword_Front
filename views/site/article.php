...
<div class="container">
    <div class="row">
        <div class="col-md-3">
            <h4 style="text-align: center; margin-top: 20px; color: black">GET THESE FOR FREE</h4>
                <ul style="list-style: none; font-size: 14px">
                    <li> <i style="color: #2e6da4;" class="fa fa-check fa-2x" aria-hidden="true"></i> Free Turnitin Plagiarism report</li>
                    <li> <i style="color: #2e6da4;" class="fa fa-tasks fa-2x" aria-hidden="true"></i> Free work in progress drafts</li>
                    <li> <i style="color: #2e6da4;" class="fa fa-repeat fa-2x" aria-hidden="true"></i> Free revisions for all orders</li>
                </ul>
            <br>
                <ul style="list-style: none; font-size: 14px">
                    <li> <i style="color: #2e6da4;" class="fa fa-envelope-o fa-2x" aria-hidden="true"></i> Free text/email updates</li>
                    <li> <i style="color: #2e6da4;" class="fa fa-phone fa-2x" aria-hidden="true"></i> Free 24/7 VIP customer support</li>
                    <li> <i style="color: #2e6da4;" class="fa fa-file-text-o fa-2x" aria-hidden="true"></i> Free 1 page summary.</li>
                </ul>
            <br>
                <ul style="list-style: none; font-size: 14px">
                    <li> <i style="color: #2e6da4;" class="fa fa-file-pdf-o fa-2x" aria-hidden="true"></i> Free cover page</li>
                    <li> <i style="color: #2e6da4;" class="fa fa-list-alt fa-2x" aria-hidden="true"></i> Free references page</li>
                    <li> <i style="color: #2e6da4;" class="fa fa-pencil-square-o fa-2x" aria-hidden="true"></i> Free formatting for your work</li>
                </ul>
            <h4 style="margin-left: 20px">Share with friends</h4>
            <ul>
                <li class="share-class">
                    <?= FacebookPlugin::widget(['type'=>FacebookPlugin::SHARE,
                        'settings' => ['size'=>'large', 'image'=>'<img href="'.Yii::$app->request->baseUrl.'/images/process/home_page.png" alt="'.$article->slug.'">',
                            'layout'=>'button_count', 'mobile_iframe'=>'false', 'href'=>Yii::$app->request->url]])?>
                </li>
                <li style="margin-top: 20px" class="share-class">
                    <?=TwitterPlugin::widget(['type'=>TwitterPlugin::SHARE, 'settings' =>
                        ['url'=> 'https://doctorateessays.com/site/article/'.$article->slug.'',
                            'text'=>$article->title,
                            'size'=>'large',
                            'via'=>'doctorateessays']])?>
                </li>
        ...
        <div class="col-md-6">
            <h2 class="text-primary" style="text-align: center;"><?= \yii\helpers\Html::encode($this->title) ?></h2>
            <div class="essay-font" style="font-size: 16px; text-align: justify; text-justify: inter-word;">
                <?= $article->blog?>
            </div>
            <div style="margin-bottom: 20px;">
                <center><a style="border-radius: 30px" type="button" href="<?= Url::to(['/order/create'])?>" class="btn btn-lg btn-primary essay-font">Order Now</a></center>
            </div>
