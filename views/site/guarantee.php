    ...
    <div class="row site-about">
        <div class="col-md-8 col-md-offset-2">
            ...
            <p>Are you afraid that you might lose money by paying for an essay that does not meet your expectations?
                You do not need to worry anymore. We have made sure to take care of this in our Money Back Guarantee
                policy.
                We are a legitimate company offering the best essay writing service to more than 1 million students from
                across the globe.
            ...
            <ol>
                <li>In the case the customer creates a duplicate order and wishes to cancel one of the order,
                    the customer can cancel the order and claim a refund of the amount paid for the order.
                </li>
                <li>The customer can change his/her mind concerning an order for which he/she has already reserved
                    money.
                    In this case, the customer has the right to cancel the order and request a refund.
                    However, we recommend that the customer be careful when placing an order such that he/she is sure
                    about
                    the order to avoid cancellations. If a customer cancels an order that had already been assigned to a
                    writer,
                    we reserve the right to hold back some money to compensate the writer for the time consumed working
                    on the order.
                    ...
                    entitled to a refund of not more than 50% of the total order cost. We, therefore, recommend that our
                    customers
                    confirm their order details before assigning the order to the writer.
                </li>
                <li>If the writer delivers low quality or plagiarized work to the customer,
                    the customer reserves the right to cancel the order and request for a refund of the total order
                    cost.
                    ...
                    Releasing the funds to the writer means that you have gone through the work and that you are
                    satisfied with it.
                    Therefore you confirm that you will not bring any other claim regarding the quality of the work
                ...
                <li>If a customer deposits money in their wallet and wishes to withdraw it without creating an order,
                    we allow them to do so. We take 2 working days to process such withdraw requests.
                </li>
        </div>
    </div>
</div>
